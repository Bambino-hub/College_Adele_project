...
final class StagiaireController extends AbstractController
{
    ...
    #[Route('/{id}', name: 'app_stagiaire_show', methods: ['GET'], requirements: ['id' => '\d+'])]
    ...
    #[Route('/{id}/edit', name: 'app_stagiaire_edit', methods: ['GET', 'POST'], requirements: ['id' => '\d+'])]
    ...
    #[Route('/{id}', name: 'app_stagiaire_delete', methods: ['POST'], requirements: ['id' => '\d+'])]
