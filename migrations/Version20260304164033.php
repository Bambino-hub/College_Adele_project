 ...
 */
final class Version20260304164033 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE class_name ADD niveau_id INT NOT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_EA5E4949B3E9C81 ON class_name (niveau_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_EA5E4949B3E9C81 ON class_name');
        $this->addSql('ALTER TABLE class_name DROP niveau_id');
        $this->addSql('ALTER TABLE examen DROP FOREIGN KEY FK_514C8FECF46CD258');
